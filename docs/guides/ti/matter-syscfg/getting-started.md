...
The location of the Matter syscfg file follows one of these formats:

-   `/examples/<application>/<device>/chip.syscfg`
-   `/examples/<application>/ti/<device>/chip.syscfg`

For example, on the GitHub web with application lock-app and device
CC13x4/CC26x4:
