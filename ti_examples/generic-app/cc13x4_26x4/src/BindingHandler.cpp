...
#include "include/BindingHandler.h"
...
void ApplicationChangedHandler(const EmberBindingTableEntry & binding, OperationalDeviceProxy * peer_device, void * context)
{
...
void ApplicationContextReleaseHandler(void * context)
{
    VerifyOrReturn(context != nullptr, ChipLogError(NotSpecified, "ApplicationContextReleaseHandler: context is null"));
...
void InitBindingHandlerInternal(intptr_t arg)
{
    ...
    chip::BindingManager::GetInstance().RegisterBoundDeviceChangedHandler(ApplicationChangedHandler);
    chip::BindingManager::GetInstance().RegisterBoundDeviceContextReleaseHandler(ApplicationContextReleaseHandler);
}
...
void ApplicationWorkerFunction(intptr_t context)
{
    VerifyOrReturn(context != 0, ChipLogError(NotSpecified, "ApplicationWorkerFunction - Invalid work data"));
