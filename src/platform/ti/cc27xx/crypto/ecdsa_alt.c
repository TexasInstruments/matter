 ...
 *       order. This is in contrast to the mbedtls_mpi structures which store
                         ...
                         const mbedtls_mpi * r, const mbedtls_mpi * s)
{
    ...
    case MBEDTLS_ECP_DP_SECP224R1:
        operationVerify.curveType = ECDSA_TYPE_SEC_P_224_R1;
        break;

    case MBEDTLS_ECP_DP_SECP256R1:
        operationVerify.curveType = ECDSA_TYPE_SEC_P_256_R1;
        break;

    case MBEDTLS_ECP_DP_SECP384R1:
        operationVerify.curveType = ECDSA_TYPE_SEC_P_384_R1;
        break;

    case MBEDTLS_ECP_DP_SECP521R1:
        operationVerify.curveType = ECDSA_TYPE_SEC_P_521_R1;
        break;

    case MBEDTLS_ECP_DP_BP256R1:
        operationVerify.curveType = ECDSA_TYPE_BRP_P_256_R1;
        break;

    case MBEDTLS_ECP_DP_BP384R1:
        operationVerify.curveType = ECDSA_TYPE_BRP_P_384_R1;
        break;

    case MBEDTLS_ECP_DP_BP512R1:
        operationVerify.curveType = ECDSA_TYPE_BRP_P_512_R1;
        break;
                       ...
                       size_t blen, int (*f_rng)(void *, unsigned char *, size_t), void * p_rng)
{
    ...
    {
    case MBEDTLS_ECP_DP_SECP224R1:
        operationSign.curveType = ECDSA_TYPE_SEC_P_224_R1;
        break;
    ...
    case MBEDTLS_ECP_DP_SECP384R1:
        operationSign.curveType = ECDSA_TYPE_SEC_P_384_R1;
        break;

    case MBEDTLS_ECP_DP_SECP521R1:
        operationSign.curveType = ECDSA_TYPE_SEC_P_521_R1;
        break;

    case MBEDTLS_ECP_DP_BP256R1:
        operationSign.curveType = ECDSA_TYPE_BRP_P_256_R1;
        break;

    case MBEDTLS_ECP_DP_BP384R1:
        operationSign.curveType = ECDSA_TYPE_BRP_P_384_R1;
        break;

    case MBEDTLS_ECP_DP_BP512R1:
        operationSign.curveType = ECDSA_TYPE_BRP_P_512_R1;
        break;
