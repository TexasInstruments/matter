...
/**
 * Concrete implementation of the ConnectivityManager singleton object for the CC27xxx platforms.
 */
...
public:
    ...
    void StartNonConcurrentThreadManagement();
#endif
private:
