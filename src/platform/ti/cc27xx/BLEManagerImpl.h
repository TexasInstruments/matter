...
#define ICALL_EVT 0x00010000 // Event_Id_31
#define QUEUE_EVT 0x00100000 // Event_Id_30
#define QUEUE_STATIC_EVT 0x00100001
// Bitwise OR of all RTOS events to pend on
#define BLEManagerIMPL_ALL_EVENTS (ICALL_EVT | QUEUE_EVT | QUEUE_STATIC_EVT)
#else
// Internal Events for RTOS application
...
private:
    ...
    void CheckNonConcurrentBleClosing();
#endif
...
#if defined(DeviceFamily_CC27XXX10) || defined(DeviceFamily_CC27XXX20)
    static QueueHandle_t sEventHandlerMsgQueueIDStatic;
#endif
    ...
    // Address mode
    GAP_Addr_Modes_t addrMode = ADDRMODE_RP_WITH_PUBLIC_ID;
...
#if defined(DeviceFamily_CC27XXX10) || defined(DeviceFamily_CC27XXX20)
    status_t EnqueueEvtHdrMsgStatic(uint8_t event, void * pData);
#endif
