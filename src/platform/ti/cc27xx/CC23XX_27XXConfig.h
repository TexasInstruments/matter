...
public:
    ...
    static const uint16_t kCC23XX_27XXMatter_SysID = kNvinf_sysid_chip;

    static const uint16_t kCC23XX_27XXMatter_ItemID_ChipConfig    = kNVinf_itemid_chipConfig;
    static const uint16_t kCC23XX_27XXMatter_ItemID_ChipFactory   = kNVinf_itemid_chipFactory;
    static const uint16_t kCC23XX_27XXMatter_ItemID_ChipCounters  = kNVinf_itemid_chipCounters;
    static const uint16_t kCC23XX_27XXMatter_ItemID_ChipKVS_key   = kNVinf_itemid_chipKVS_key;
    static const uint16_t kCC23XX_27XXMatter_ItemID_ChipKVS_value = kNVinf_itemid_chipKVS_value;
...
inline bool CC23XX_27XXConfig::Key::operator==(const Key & other) const
{
