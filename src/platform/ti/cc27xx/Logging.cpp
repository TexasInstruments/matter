...
#include <platform/ti/cc27xx/Logging.h>
...
#if MATTER_CC27XX_PLATFORM_LOG_ENABLED
extern "C" int cc27xxLogInit(void)
{
    uartConsoleInit();
    return 0;
}

extern "C" void cc27xxVLog(const char * msg, va_list v)
{
    int ret;
...
extern "C" int cc27xxLogInit(void) { return 0;}
extern "C" void cc27xxVLog(const char * msg, va_list v) {};

#endif // MATTER_CC27XX_PLATFORM_LOG_ENABLED
 ...
 */
extern "C" void cc27xxLog(const char * msg, ...)
{
    va_list v;
