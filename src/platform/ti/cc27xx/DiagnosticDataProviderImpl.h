...
/**
 * @file
 *   DiagnosticDataProvider for cc27xx.
 *
 * TODO(improvement#1): Implement using cc27xx-specific APIs:
 *   - Heap stats: xPortGetFreeHeapSize() / xPortGetMinimumEverFreeHeapSize() (FreeRTOS)
 *   - Boot reason: PMCTLGetResetReason() from driverlib/pmctl.h
 *   - Thread metrics: FreeRTOS task list APIs
 */
