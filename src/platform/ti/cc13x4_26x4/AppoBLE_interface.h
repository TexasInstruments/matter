...
#define ADV_INDEX_INVALID (0xFF)
     ...
     */
    bStatus_t SendAppoBLEIndication(BLE_CONNECTION_OBJECT conId, const chip::Ble::ChipBleUUID * svcId, const chip::Ble::ChipBleUUID * charId,
     ...
     * @return @ref SUCCESS if write request was successfully sent to BLE Manager, FALSE otherwise
     */
    bStatus_t SendAppoBLEWriteRequest(BLE_CONNECTION_OBJECT conId, const chip::Ble::ChipBleUUID * svcId, const chip::Ble::ChipBleUUID * charId,
                                      uint8_t * srcBuf, uint16_t srcBufLen);
     ...
     * @return @ref SUCCESS if write request was successfully sent to BLE Manager, FALSE otherwise
     */
    bStatus_t SendAppoBLEReadRequest(BLE_CONNECTION_OBJECT conId, const chip::Ble::ChipBleUUID * svcId, const chip::Ble::ChipBleUUID * charId,
     ...
     */
    chip::DeviceLayer::ConnectivityManager::CHIPoBLEServiceMode GetMatteroBLEServiceMode(BLE_CONNECTION_OBJECT conId);
     ...
     */
    uint8_t AppoBLE_GenericSetParameter(BLE_CONNECTION_OBJECT connObj, const chip::Ble::ChipBleUUID * svcId, const chip::Ble::ChipBleUUID * charId,
     ...
     */
    uint8_t AppoBLE_GenericGetParameter(BLE_CONNECTION_OBJECT connObj, const chip::Ble::ChipBleUUID * svcId, const chip::Ble::ChipBleUUID * charId,
     ...
     * @param charId Characteristic ID on which to send the write request
     */
    __attribute__((weak)) void HandleAppoBLEWriteConfirmation(BLE_CONNECTION_OBJECT connObj, const chip::Ble::ChipBleUUID * svcId,
     ...
     */
    __attribute__((weak)) void HandleAppoBLEReadConfirmation(BLE_CONNECTION_OBJECT connObj, const chip::Ble::ChipBleUUID * svcId,
                                                             const chip::Ble::ChipBleUUID * charId, const uint8_t * dstBuf, uint16_t dstBufLen,
                                                             uint8_t status);
    /**
     ...
     *
     */
    __attribute__((weak)) void HandleAppoBLEWriteReceived(BLE_CONNECTION_OBJECT conId, const chip::Ble::ChipBleUUID * svcId,
                                                          const chip::Ble::ChipBleUUID * charId, uint8_t const * dstBuf, uint16_t dstBufLen,
                                                          uint8_t status);
     ...
     */
    __attribute__((weak)) void HandleAppoBLEWriteConfirmation(BLE_CONNECTION_OBJECT connObj, const chip::Ble::ChipBleUUID * svcId,
                                                              const chip::Ble::ChipBleUUID * charId, uint8_t status);
