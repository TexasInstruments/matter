...
The CC27XX light-switch example application provides a working demonstration of
a connected light-switch device. This uses the open-source Matter implementation
and the Texas Instruments SimpleLink™ LPF3 software development kit.
...
-   If building for the CC2755P20 LaunchPad, in `args.gni` modify the field shown below.
    ```
...
-   Run the build to produce a default executable. By default on Linux both the
    ...
    ```
    $ cd ~/connectedhomeip/examples/light-switch-app/ti/cc27xx
