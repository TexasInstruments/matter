...
This example is enabled to build for CC2745P10-Q1 devices.
...
-   Run the build to produce a default executable. By default on Linux both the
    ...
    ```
    $ cd ~/connectedhomeip/examples/light-switch-app/cc27xx
    ...
    ```
    gn gen out/debug --args="ti_sysconfig_root=\"$HOME/ti/sysconfig-1.22.0\" target_defines=[\"TI_ATTESTATION_CREDENTIALS=1\"] chip_generate_link_map_file=true"
