...
bool K32WOTARequestorDriver::CheckImageDownloadAllowed()
{
    return true;
}

// Notify the application that the download is complete and the image can be applied
void K32WOTARequestorDriver::ImageDownloadComplete() {}

UserConsentAction K32WOTARequestorDriver::RequestUserConsent()
{
    return ImmediateYes;
}
