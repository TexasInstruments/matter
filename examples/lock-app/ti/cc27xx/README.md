...
The CC27xx lock example application provides a working demonstration of a
connected door lock device. This uses the open-source Matter implementation and
the Texas Instruments SimpleLink™ LPF3 software development kit.
...
-   Run the build to produce a default executable. By default on Linux both the
    ...
    ```
    $ cd ~/connectedhomeip/examples/lock-app/ti/cc27xx
